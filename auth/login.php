        ...
        <form action="AuthControl.php" method="post">
            ...
            if (isset($_GET['error']) && isset($_GET['errorCode'])) {
                if ($_GET['errorCode'] == "101") {
                    echo "<p>Unkown request</p>";
                }
                if ($_GET['errorCode'] == "102") {
                    echo "<p>Empty field found</p>";
                }
                if ($_GET['errorCode'] == "103") {
                    echo "<p>Your are not allowed to login</p>";
                }
            }
            ?>
            </div>
            ...
            <p>New for TTC Create Account <a href="index.php">here</a></p>
        </form>
    </div>
</div>
    <script>
